...
# ─── Google Drive File IDs (ضع هنا الـ ID بعد رفع الملف على Drive) ───────────
DRIVE_FILE_ID = "1pqDgy3bQ0hKbTE3SirzR3NaBRGa0Gmsr"

@st.cache_resource(show_spinner="📥 تحميل بيانات المرور... (مرة واحدة فقط)")
